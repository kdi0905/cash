					...
					<div class="container">
						<div class="row">
							<div class="from-group " style="margin: auto;">
								<button id="categoryOutByYear" class="tm-more-button tm-more-button-welcome" type="button">Chart</button>
...
<!--차트 -->
<script>
$('#categoryOutByYear').click(function(){
	if ($('#year').val() != "") {
		$.ajax({
			url: '${pageContext.request.contextPath}/admin/categoryOutByYear/'+$('#year').val(),
			type:'get',
