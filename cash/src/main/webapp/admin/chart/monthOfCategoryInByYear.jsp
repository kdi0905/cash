...
$('#chartBtn').click(function(){
	if ($('#year').val() != "") {
		$.ajax({
			url: '${pageContext.request.contextPath}/admin/MonthOfCategoryInByYear/'+$('#year').val(),
			type:'get',
